...
subjects = [438:441]; % Replace with a list of all of the subjects you wish to analyze
...
%-----------------------------------------------------------------------
    matlabbatch{1}.spm.stats.fmri_spec.dir = {[path 'fmri_G11/fmri_analysis/GLM1/1stLevel/sub-' num2str(subject) ]};
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).multi = {[path 'data/regressors/sub-' num2str(subject) '/GLM1_nodur_s1.mat']};
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess(2).multi = {[path 'data/regressors/sub-' num2str(subject) '/GLM1_nodur_s2.mat']};
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess(3).multi = {[path 'data/regressors/sub-' num2str(subject) '/GLM1_nodur_s3.mat']};
    ...
    ematlabbatch{1}.spm.stats.fmri_est.spmmat = {[path 'fmri_G11/fmri_analysis/GLM1/1stLevel/sub-' num2str(subject) '/SPM.mat']};
